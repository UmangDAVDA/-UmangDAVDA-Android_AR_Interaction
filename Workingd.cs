...
public class Workingd : MonoBehaviour
{
 ...
 public AudioSource audioRotation;   // looping rotation sound
    public AudioSource audioParticle;   // one-shot particle sound
